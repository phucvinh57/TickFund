...
export default function Sort({ onSort, fields, size }) {
    ...
    return <div className='col-auto d-flex border-left'>
        <div className='me-2'>
            <Form.Select
                value={sortOption.key} size={size}
        ...
        <div className='me-2'>
            <Form.Select
                value={sortOption.order} size={size}
        ...
        <div>
            <Button size={size} onClick={() => onSort(sortOption)}>
                Sắp xếp
            </Button>
        </div>
    </div>
